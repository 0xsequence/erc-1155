...
interface ERC1155Interface extends Interface {
  functions: {
...
export class ERC1155 extends Contract {
  connect(signerOrProvider: Signer | Provider | string): ERC1155;
  attach(addressOrName: string): ERC1155;
  deployed(): Promise<ERC1155>;

  on(event: EventFilter | string, listener: Listener): ERC1155;
  once(event: EventFilter | string, listener: Listener): ERC1155;
  addListener(eventName: EventFilter | string, listener: Listener): ERC1155;
  removeAllListeners(eventName: EventFilter | string): ERC1155;
  removeListener(eventName: any, listener: Listener): ERC1155;
