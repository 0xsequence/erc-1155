...
export interface ERC1155MintBurnMockInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "balanceOf" | "balanceOfBatch" | "baseURI" | "batchBurnMock" | "batchMintMock" | "burnMock" | "isApprovedForAll" | "mintMock" | "name" | "safeBatchTransferFrom" | "safeTransferFrom" | "setApprovalForAll" | "supportsInterface" | "uri"): FunctionFragment;
...
export interface ERC1155MintBurnMock extends BaseContract {
