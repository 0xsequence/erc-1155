...
describe('ERC1155Meta', () => {
  ...
  describe('metaSafeTransferFrom() (Meta) Function', () => {
    ...
    let feeTokenInitBalance = BigNumber.from(100000000);
    ...
    conditions.forEach(function(condition) {
      context(condition[2] as string, () => {
        ...
        beforeEach(async () => {
          ...
          // Domain hash
          domainHash = utils.keccak256(utils.solidityPack(
            ['bytes32', 'uint256'], 
        ...
        it("should REVERT if transfer data is incorrect", async () => {
          ...
          let transferData = transferObj.transferData == null ? utils.toUtf8Bytes('') : transferObj.transferData
          ...
          if (isGasReceipt) {
            ...
            badGasAndTransferData = utils.defaultAbiCoder.encode([GasReceiptType, 'bytes'], [gasReceipt, utils.toUtf8Bytes('Goodbyebyebye')])
          } else {
          ...
          let paddedNonce = utils.solidityPack(['uint256'], [transferObj.nonce])
        ...
        describe('ERC-1271 Receiver', () => {
          ...
          describe(`EIP-1271 (bytes) signatures (03)`, () => {
            it('should return REVERT if signature is invalid', async () => {
              ...
              const tx = operatorERC1155Contract.metaSafeTransferFrom(erc1271WalletAddress, receiverAddress, id, amount, isGasReceipt, data,
                {gasLimit: 2000000}
              )
              await expect(tx).to.be.rejectedWith( RevertError("ERC1155Meta#_signatureValidation: INVALID_SIGNATURE") )
            })
        ...
        describe('When signature is valid', () => {
          ...
          it('should REVERT if insufficient balance', async () => {
            ...
            const tx = operatorERC1155Contract.metaSafeTransferFrom(ownerAddress, receiverAddress, id, initBalance+1, isGasReceipt, data)
          ...
          it('should REVERT when sending to non-receiver contract', async () => {
            ...
            const tx = operatorERC1155Contract.metaSafeTransferFrom(ownerAddress, erc1155Contract.address, id, amount, isGasReceipt, data)
          ...
          it('should REVERT if invalid response from receiver contract', async () => {
            ...
            const tx = operatorERC1155Contract.metaSafeTransferFrom(ownerAddress, receiverContract.address, id, amount, isGasReceipt, data)
          ...
          describe('When gas is reimbursed', () => {
            ...
            it('should send gas fee to msg.sender is fee recipient ix 0x0', async () => {
              ...
              let receiverBalance = await erc1155Contract.balanceOf(receiverAddress, feeTokenID)
            ...
            it("should send gas fee to specified fee recipient (if not 0x0), not tx.origin", async () => {
              await receiverERC1155Contract.metaSafeTransferFrom(ownerAddress, receiverAddress, id, amount, isGasReceipt, data)
              let operatorBalance = await erc1155Contract.balanceOf(operatorAddress, feeTokenID)
            ...
            it("should REVERT if gasReceipt is incorrect", async () => {
              ...
              // Correct and incorrect transferData
              let goodGasAndTransferData = utils.defaultAbiCoder.encode([GasReceiptType, 'bytes'], [gasReceipt, transferData])
              let badGasAndTransferData = utils.defaultAbiCoder.encode([GasReceiptType, 'bytes'], [badGasReceipt, transferData])
            ...
            it("should PASS if approved ERC20 is used for fee", async () => {
              ...
              let feeTokenDataERC20 = utils.defaultAbiCoder.encode(
            ...
            it("should REVERT if FeeTokenType is not supported", async () => {
              ...
              feeTokenDataERC20 = utils.defaultAbiCoder.encode(
            ...
            it("should REVERT if gas receipt is passed, but not claimed", async () => {
              let tx = operatorERC1155Contract.metaSafeTransferFrom(ownerAddress, receiverAddress, id, amount, false, data)
              await expect(tx).to.be.rejectedWith( RevertError("ERC1155Meta#_signatureValidation: INVALID_SIGNATURE") )
            })
            ...
            it("should REVERT if gas receipt is passed but isGasFee is false", async () => {
              ...
              data = await encodeMetaTransferFromData(transferObj, domainHash, gasReceipt)
              let tx = operatorERC1155Contract.metaSafeTransferFrom(ownerAddress, receiverAddress, id, amount, true, data)
              await expect(tx).to.be.rejectedWith( RevertError("ERC1155Meta#_signatureValidation: INVALID_SIGNATURE") )
            })
            ...
            describe('When receiver is a contract', () => {
              ...
              it('should REVERT if gas used in onERC1155Received exceeds limit', async () => {
                ...
                let tx = operatorERC1155Contract.metaSafeTransferFrom(ownerAddress, receiverContract.address, id, amount, isGasReceipt, data, 
                  {gasLimit: 2000000}
                )
                await expect(tx).to.be.rejectedWith(RevertError())
              })
          ...
          context('When successful transfer', () => {
            ...
            beforeEach(async () => {
              tx = await operatorERC1155Contract.metaSafeTransferFrom(ownerAddress, receiverAddress, id, amount, isGasReceipt, data)
            })
            ...
            describe('TransferSingle event', async () => {
              ...
              it('should have `msg.sender` as `_operator` field, not tx.origin', async () => {
                ...
                await operatorContract.metaSafeTransferFrom(erc1155Contract.address, ownerAddress, receiverAddress, id, amount, isGasReceipt, data, 
                ...
                let args = erc1155Contract.interface.decodeEventLog(erc1155Contract.interface.events["TransferSingle(address,address,address,uint256,uint256)"], logs[0].data, logs[0].topics)
    ...
    conditions.forEach(function(condition) {
      context(condition[2] as string, () => {
        ...
        it("should REVERT if contract address is incorrect", async () => {
          ...
          const tx = operatorERC1155Contract.metaSafeBatchTransferFrom(ownerAddress, receiverAddress, ids, amounts, isGasReceipt, data)
          await expect(tx).to.be.rejectedWith( RevertError("ERC1155Meta#_signatureValidation: INVALID_SIGNATURE") )    
        })
        ...
        it("should REVERT if nonce is incorrect", async () => {
          ...
          // Nonce lower
          const tx2 = operatorERC1155Contract.metaSafeBatchTransferFrom(ownerAddress, receiverAddress, ids, amounts, isGasReceipt, data)
          await expect(tx2).to.be.rejectedWith( RevertError("ERC1155Meta#_signatureValidation: INVALID_NONCE") ) 
        })
        ...
        describe('ERC-1271 Receiver', () => {
          ...
          describe(`EIP-1271 (bytes) signatures (03)`, () => {
            it('should return REVERT if signature is invalid', async () => {
              ...
              const tx = operatorERC1155Contract.metaSafeBatchTransferFrom(erc1271WalletAddress, receiverAddress, ids, amounts, isGasReceipt, data)
              await expect(tx).to.be.rejectedWith( RevertError("ERC1155Meta#_signatureValidation: INVALID_SIGNATURE") )
            })
          })
        ...
        describe('When signature is valid', () => {
          ...
          it('should REVERT if sending to 0x0', async () => {
            ...
            const tx = operatorERC1155Contract.metaSafeBatchTransferFrom(ownerAddress, ZERO_ADDRESS, ids, amounts, isGasReceipt, data)
          ...
          it('should REVERT when sending to non-receiver contract', async () => {
            ...
            const tx = operatorERC1155Contract.metaSafeBatchTransferFrom(ownerAddress, erc1155Contract.address, ids, amounts, isGasReceipt, data)
            await expect(tx).to.be.rejectedWith(RevertError("ERC1155MetaMintBurnMock: INVALID_METHOD"));
          })
          ...
          it('should REVERT if invalid response from receiver contract', async () => {
            ...
            const tx = operatorERC1155Contract.metaSafeBatchTransferFrom(ownerAddress, receiverContract.address, ids, amounts, isGasReceipt, data)
            await expect(tx).to.be.rejectedWith( RevertError() )
          })
          ...
          describe('When gas is reimbursed', () => {
            ...
            it('should send gas fee to tx.origin is fee recipient ix 0x0', async () => {
              ...
              await receiverERC1155Contract.metaSafeBatchTransferFrom(ownerAddress, receiverAddress, ids, amounts, isGasReceipt, data)

              let receiverBalance = await operatorERC1155Contract.balanceOf(receiverAddress, feeTokenID)
            ...
            it("should send gas fee to specified fee recipient (if not 0x0), not tx.origin", async () => {
              await receiverERC1155Contract.metaSafeBatchTransferFrom(ownerAddress, receiverAddress, ids, amounts, isGasReceipt, data)
              let operatorBalance = await operatorERC1155Contract.balanceOf(operatorAddress, feeTokenID)
            ...
            it("should REVERT if gas receipt is passed, but not claimed", async () => {
              let tx = operatorERC1155Contract.metaSafeBatchTransferFrom(ownerAddress, receiverAddress, ids, amounts, false, data)
              await expect(tx).to.be.rejectedWith( RevertError("ERC1155Meta#_signatureValidation: INVALID_SIGNATURE") )
            })
            ...
            it("should REVERT if gas receipt is passed but isGasFee is false", async () => {
              transferObj.isGasFee = false
              data = await encodeMetaBatchTransferFromData(transferObj, domainHash, gasReceipt)
              let tx = operatorERC1155Contract.metaSafeBatchTransferFrom(ownerAddress, receiverAddress, ids, amounts, true, data)
              await expect(tx).to.be.rejectedWith( RevertError("ERC1155Meta#_signatureValidation: INVALID_SIGNATURE") )
            })
            ...
            describe('When receiver is a contract', () => {
              ...
              it('should REVERT if gas used in onERC1155BatchReceived exceeds limit', async () => {
                ...
                let tx = operatorERC1155Contract.metaSafeBatchTransferFrom(ownerAddress, receiverContract.address, ids, amounts, isGasReceipt, data, 
                  {gasLimit: 2000000}
                )
                await expect(tx).to.be.rejectedWith(RevertError())
              })
          ...
          context('When successful transfer', () => {
            ...
            beforeEach(async () => {
              tx = await operatorERC1155Contract.metaSafeBatchTransferFrom(ownerAddress, receiverAddress, ids, amounts, isGasReceipt, data)
            })
            ...
            describe('TransferBatch event', async () => {
              ...
              it('should have `msg.sender` as `_operator` field, not tx.origin', async () => {
                ...
                // Execute transfer from operator contract
                // @ts-ignore (https://github.com/ethereum-ts/TypeChain/issues/118)
                await operatorContract.metaSafeBatchTransferFrom(erc1155Contract.address, ownerAddress, receiverAddress, ids, amounts, isGasReceipt, data, 
                ...
                filterFromOperatorContract.fromBlock = 0;
                let logs = await operatorProvider.getLogs(filterFromOperatorContract);
                let args = erc1155Contract.interface.decodeEventLog(erc1155Contract.interface.events["TransferBatch(address,address,address,uint256[],uint256[])"], logs[0].data, logs[0].topics)
  ...
  describe('metaSetApprovalForAll() function', () => {
    ...
    conditions.forEach(function(condition) {
      context(condition[1] as string, () => {
        ...
        it("should PASS if signature is valid", async () => {
          let tx = operatorERC1155Contract.metaSetApprovalForAll(ownerAddress, operatorAddress, approved, isGasReimbursed, data)
          await expect(tx).to.be.fulfilled
        })
        ...
        describe('ERC-1271 Receiver', () => {
          ...
          describe(`EIP-1271 (bytes) signatures (03)`, () => {
            it('should return REVERT if signature is invalid', async () => {
              ...
              let tx = operatorERC1155Contract.metaSetApprovalForAll(erc1271WalletAddress, operatorAddress, approved, isGasReimbursed, data)
              await expect(tx).to.be.rejectedWith( RevertError("ERC1155Meta#_signatureValidation: INVALID_SIGNATURE") )
            })
          })
        ...
        describe('When gas is reimbursed', () => {
          ...
          it("should REVERT if gas receipt is passed, but not claimed", async () => {
            let tx = operatorERC1155Contract.metaSetApprovalForAll(ownerAddress, operatorAddress, approved, false, data)
            await expect(tx).to.be.rejectedWith( RevertError("ERC1155Meta#_signatureValidation: INVALID_SIGNATURE") )
          })
          ...
          it("should REVERT if gas receipt is passed but isGasFee is false", async () => {
            ...
            data = await encodeMetaApprovalData(approvalObj, domainHash, gasReceipt)
            let tx = operatorERC1155Contract.metaSetApprovalForAll(ownerAddress, operatorAddress, approved, true, data)
            await expect(tx).to.be.rejectedWith( RevertError("ERC1155Meta#_signatureValidation: INVALID_SIGNATURE") )
          })
        ...
        it("should REVERT if nonce is incorrect", async () => {
          ...
          // Nonce lower
          const tx2 = operatorERC1155Contract.metaSetApprovalForAll(ownerAddress, operatorAddress, approved, isGasReimbursed, data)
          await expect(tx2).to.be.rejectedWith( RevertError("ERC1155Meta#_signatureValidation: INVALID_NONCE") ) 
        })


        it('should emit an ApprovalForAll event', async () => {
          let tx = await operatorERC1155Contract.metaSetApprovalForAll(ownerAddress, operatorAddress, approved, isGasReimbursed, data)
          const receipt = await tx.wait(1)
        ...
        context('When the operator was already an operator', () => {
          ...
          it('should allow the operator status to be set to false', async () => {
            ...
            let tx = operatorERC1155Contract.metaSetApprovalForAll(ownerAddress, operatorAddress, false, isGasReimbursed, data)
            await expect(tx).to.be.fulfilled
