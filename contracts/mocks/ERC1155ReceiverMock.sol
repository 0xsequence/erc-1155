...
contract ERC1155ReceiverMock {
    ...
    public returns(bytes4)
  {
    ...
    uint256 fromBalance = ERC1155(msg.sender).balanceOf(_from, _id);
    uint256 toBalance = ERC1155(msg.sender).balanceOf(address(this), _id);
    ...
    public returns(bytes4)
  {
    ...
    uint256[] memory fromBalances = ERC1155(msg.sender).balanceOfBatch(fromAddressArray, _ids);
    uint256[] memory toBalances = ERC1155(msg.sender).balanceOfBatch(toAddressArray, _ids);
