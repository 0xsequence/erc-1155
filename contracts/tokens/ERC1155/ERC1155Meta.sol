...
contract ERC1155Meta is ERC1155, SignatureValidator {
  ...
  /**
   * @dev Verifies if a transfer signature is valid based on data and update nonce
   * @param _from The address which you want to send tokens from
   * @param _to The address which you want to transfer to
   * @param _id Token id to update balance of - For this implementation, via `uint256(tokenAddress)`.
   * @param _value The amount of tokens of provided token ID to be transferred
  ...
  /**
   * @dev Verifies if a batch transfer signature is valid based on data and update nonce
   * @param _from The address to batchTransfer objects from.
   * @param _to The address to batchTransfer objects to.
   * @param _ids Array of ids to update balance of - For this implementation, via `uint256(tokenAddress)`
   * @param _values Array of amount of object per id to be transferred.
  ...
  /**
   * @dev Verifies if an approval is a signature is valid based on data
  ...
  */
  ...
  /**
   * @dev Will reimburse tx.origin or fee recipient for the gas spent execution a transaction
