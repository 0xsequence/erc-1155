...
interface ERC1155MintBurnPackedBalanceMockInterface extends Interface {
  functions: {
...
export class ERC1155MintBurnPackedBalanceMock extends Contract {
  ...
  attach(addressOrName: string): ERC1155MintBurnPackedBalanceMock;
  deployed(): Promise<ERC1155MintBurnPackedBalanceMock>;
