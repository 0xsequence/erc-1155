...
export interface ERC1155MetadataMockInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "balanceOf" | "balanceOfBatch" | "baseURI" | "isApprovedForAll" | "logURIsMock" | "name" | "safeBatchTransferFrom" | "safeTransferFrom" | "setApprovalForAll" | "setBaseMetadataURI" | "supportsInterface" | "uri"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "logURIsMock", values: [PromiseOrValue<BigNumberish>[]]): string;
    ...
    decodeFunctionResult(functionFragment: "logURIsMock", data: BytesLike): Result;
...
export interface ERC1155MetadataMock extends BaseContract {
    ...
    functions: {
        ...
        logURIsMock(_tokenIDs: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
    ...
    callStatic: {
        ...
        baseURI(overrides?: CallOverrides): Promise<string>;
        isApprovedForAll(_owner: PromiseOrValue<string>, _operator: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        logURIsMock(_tokenIDs: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<void>;
        name(overrides?: CallOverrides): Promise<string>;
