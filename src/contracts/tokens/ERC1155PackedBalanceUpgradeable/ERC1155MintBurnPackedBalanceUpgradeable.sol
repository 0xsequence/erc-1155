 ...
 *      a parent contract to be executed as they are `internal` functions. This contract
 *      uses an upgradeable context.
 */
contract ERC1155MintBurnPackedBalanceUpgradeable is ERC1155PackedBalanceUpgradeable {
    ...
    internal virtual
  {
    ...
    // //Emit event
    emit TransferBatch(_msgSender(), address(0x0), _to, _ids, _amounts);
    ...
    internal virtual
  {
    ...
    emit TransferBatch(_msgSender(), _from, address(0x0), _ids, _amounts);
  }
}
