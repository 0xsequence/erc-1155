...
export interface ERC2981GlobalMockInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "balanceOf" | "balanceOfBatch" | "baseURI" | "batchBurnMock" | "batchMintMock" | "burnMock" | "globalRoyaltyInfo" | "isApprovedForAll" | "mintMock" | "name" | "royaltyInfo" | "safeBatchTransferFrom" | "safeTransferFrom" | "setApprovalForAll" | "setGlobalRoyaltyInfo" | "supportsInterface" | "uri"): FunctionFragment;
...
export interface ERC2981GlobalMock extends BaseContract {
    ...
    functions: {
        ...
        setGlobalRoyaltyInfo(_recipient: PromiseOrValue<string>, _royaltyBasisPoints: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setGlobalRoyaltyInfo(_recipient: PromiseOrValue<string>, _royaltyBasisPoints: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        supportsInterface(_interfaceID: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<boolean>;
        uri(_id: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
    };
    filters: {
